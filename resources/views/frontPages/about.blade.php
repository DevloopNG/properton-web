@include('partials.header')
            ...
            <div class="container">				
                <div class="row d-flex align-items-center justify-content-center">
                    <div class="about-content col-lg-12">
                        ...
                        <p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href=""> About Me</a></p>
                    </div>	
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-6 col-md-6 home-about-left">
                        <img class="img-fluid" src="asset/img/about-img.png" alt="">
                    </div>
        ...
        <div class="text-center">
          ...
          <ul>
            ...
            <li>
              <div class="content">
                  <img class="img-fluid mx-auto d-block mb-30" src="asset/img/about/c-logo.png" alt="">
                <h4>
