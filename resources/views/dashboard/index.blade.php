...
<body>
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">  
          <a class="navbar-brand brand-logo" href=""><img src="" alt="properton logo"/></a>
          <a class="navbar-brand brand-logo-mini" href=""><img src="" alt="properton logo"/></a>
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="{{asset('admin-asset/images/faces/face5.jpg')}}" alt="profile"/>
              <span class="nav-profile-name">Sadio Mane</span>
            </a>
      ...
      <div class="main-panel">
              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  <div class="mr-md-3 mr-xl-5">
                    <h2>Welcome back,</h2>
                    <p class="mb-md-0">Your Properton dashboard.</p>
                  </div>
                  <div class="d-flex">
            ...
            <div class="col-md-12 grid-margin">
              <div class="card bg-gradient-primary border-0">
                <div class="card-body py-3 px-4 d-flex align-items-center justify-content-between flex-wrap">
                  <p class="mb-0 text-white font-weight-medium">Like what you see?</p>
                  <div class="d-flex">
                    <a href="" target="_blank" class="btn btn-outline-light mr-2">Action</a>
                    <a href="" target="_blank" class="btn btn-outline-light mr-2 bg-gradient-danger border-0">Action Button</a>
        ...
        <footer class="footer">
          <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2018 <a href="" target="_blank">Hello</a>. All rights reserved.</span>
  ...
  <script src="{{asset('admin-asset/js/data-table.js')}}"></script>
  <script src="{{asset('admin-asset/js/jquery.dataTables.js')}}"></script>
  <script src="{{asset('admin-asset/js/dataTables.bootstrap4.js')}}"></script>
